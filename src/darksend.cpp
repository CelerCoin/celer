...
{
    if(fLiteMode) return; // ignore all Celer related functionality
...
/*
    ...
    allow endless transaction that would bloat Celer and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("celer-privatesend");
