    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Celer Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Celer address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and celer: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Celer Core"), this);
    aboutAction->setStatusTip(tr("Show information about Celer Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Celer Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Celer addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Celer addresses"));
    ...
    openAction->setStatusTip(tr("Open a celer: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Celer Core help message to get a list with possible Celer Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Celer Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Celer network", "", count));
}
...
{
    QString strTitle = tr("Celer Core"); // default title
