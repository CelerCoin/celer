...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setStyleSheet(QStringLiteral("QLabel { color: black; }"));
        ...
        labelPrivateSendSyncStatus->setStyleSheet(QStringLiteral("QLabel { color: black; }"));
        ...
        labelAnonymized->setText(QStringLiteral("0 CELER"));
        ...
        labelTransactionsStatus->setStyleSheet(QStringLiteral("QLabel { color: black; }"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Celer network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelPrivateSendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Celer network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 CELER / 0 Rounds", 0));
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Celer network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
