    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CELER-light"), QVariant("light"));
    ui->theme->addItem(QString("CELER-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CELER-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CELER-traditional"), QVariant("trad"));
