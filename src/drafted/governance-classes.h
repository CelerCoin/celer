 ...
 *
 *   // network
 *   CCelerNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.celercoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCelerNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CelerNetwork
// //   -- signature requirements : Key1(User)
// class CCelerNetworkVariable : public CGovernanceObject
// {
// private:
