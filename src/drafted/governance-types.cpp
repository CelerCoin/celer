...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CelerNetwork") type = CelerNetwork;
    if(strType == "CelerNetworkVariable") type = CelerNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CelerNetwork) s = "CelerNetwork";
    if(type == CelerNetworkVariable) s = "CelerNetworkVariable";
