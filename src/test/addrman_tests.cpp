...
BOOST_AUTO_TEST_CASE(addrman_simple)
{
    ...
    CNetAddr source = CNetAddr("252.2.2.2:8555");
    ...
    CService addr1 = CService("250.1.1.1:8555");
    ...
    CService addr1_dup = CService("250.1.1.1:8555");
    ...
    //  have two addrs.
    CService addr2 = CService("250.1.1.2:8555");
